...
public class DragonBonesLoader extends AsynchronousAssetLoader<AnimationNode.Group, DragonBonesLoader.Parameters> {
    ...
    public void loadAsync(
            AssetManager manager, String fileName, FileHandle file, DragonBonesLoader.Parameters parameters) {
    ...
    public Array<AssetDescriptor> getDependencies(
            String fileName, FileHandle file, DragonBonesLoader.Parameters parameters) {
